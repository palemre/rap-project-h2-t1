...
const hiphopOriginTexts = [`<span class="bigger-text">1984</span> : Run DMC par DMC et REV RUN sont l’un des <span class="important-text-hip-hop">premiers groupes</span> à avoir sorti un album sur le hip-hop devenant un incontournable du genre.`,
`<span class="bigger-text">1987</span> : Paid in full - par Eric B & Rakim, la sortie de cette album marque l’age d’or du hip hop et il figure dans la liste des <span class="important-text-hip-hop">‘500 plus grands albums</span> de tous les temps’ par le magazine Rolling Stones.`,
`<span class="bigger-text">1988</span> : Public enemy - It takes A nation Of Millions to hold Us Back. Le deuxième album de Public Enemy présente un vrai <span class="important-text-hip-hop">discours révolutionnaire</span> sur l’état de la nation.`,
`<span class="bigger-text">1996</span> : La sortie de The Score de The Fugees a <span class="important-text-hip-hop">transformé le hip hop en pop</span>, et a marqué l’histoire par leur sublimes reprises ainsi que leurs chansons aux paroles ‘conscientes’ et transmettant différents messages`, 
`<span class="bigger-text">2004</span> : The College Drop out par Kanye West, c’est un album ayant reçu <span class="important-text-hip-hop">10 nominations aux Grammy Awards</span> en 2005. Cet album a marqué l’histoire du rap par son analyse encore pertinente de l’Occident.`]
